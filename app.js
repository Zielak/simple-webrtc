...
var httpsOptions = {
  key: fs.readFileSync("/home/zielakpl/letsencrypt/webrtc.darekgreenly.com/cert.key"),
  cert: fs.readFileSync("/home/zielakpl/letsencrypt/webrtc.darekgreenly.com/cert.pem")
};
...
httpsServer.listen(1990, function() {
  log("Server is listening on port 1990");
});
